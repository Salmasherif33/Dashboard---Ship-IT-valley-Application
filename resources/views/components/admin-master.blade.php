...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      @if(auth('web-admin')->user()->type = "admin")
      <li class="nav-item">
        <a class="nav-link" href="{{route('admin.showDrivers')}}">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('admin.users_complaints')}}">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Users'Complaints and suggestions</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{route('admin.drivers_complaints')}}">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Drivers'Complaints and suggestions</span></a>
      </li>
      @elseif(auth('web-admin')->user()->type = "company")
      <li class="nav-item">
        <a class="nav-link" href="index.html">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Trucks</span></a>
